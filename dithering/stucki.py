...
def stucki_softmax(image: np.ndarray, palette: np.ndarray, weights: np.ndarray, colour_space: str = 'rgb', alpha: float = 0.5) -> np.ndarray:
    """
    As a small note on the alpha: it controls the balance between distance-based and weight-based decisions as follows
...
def stucki_error_scaled(image: np.ndarray, palette: np.ndarray, weights: np.ndarray, colour_space: str = 'rgb', mode: str = 'scale', alpha: float = 0.5, p: float = 1.0) -> np.ndarray:
    """
